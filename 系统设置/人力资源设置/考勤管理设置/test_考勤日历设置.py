...
def test_search_holiday(driver,navigate_to_calendar):
    ...
    try:
        ...
        time.sleep(1)
        wait.until(EC.element_to_be_clickable(
            (By.XPATH, '//*[@id="app"]/div/div[3]/section/div/form/div[1]/div[2]//input'))).click()

        # 等待选项加载完成
        option_locator = (By.XPATH, "//li[@class='el-select-dropdown__item' and contains(., '公休日')]")
        option = WebDriverWait(driver, 10).until(EC.visibility_of_element_located(option_locator))
...
def test_turn_today(driver,navigate_to_calendar):
    ...
    try:
        ...
        data=wait.until(EC.element_to_be_clickable((By.XPATH, '//*[@id="app"]/div/div[3]/section/div/div/div[2]/div/div[3]/div[1]/div[1]/div[1]/div[2]/div/table/tbody/tr[7]/td[2]/div/div/span/span')))
